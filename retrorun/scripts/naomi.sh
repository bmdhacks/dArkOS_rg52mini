...
$ESUDO /usr/local/bin/retrorun -c /home/ark/.config/retrorun.cfg --triggers -s /$directory/naomi -d /$directory/bios /home/ark/.config/retroarch/cores/"$2"_libretro.so "$3"
